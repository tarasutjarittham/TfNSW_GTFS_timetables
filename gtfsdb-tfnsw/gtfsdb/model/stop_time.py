...
from sqlalchemy.types import Boolean, Integer, Numeric, String, DateTime
...
class StopTime(Base):
    ...
    notes = relationship(
        'Notes',
        primaryjoin='StopTime.stop_note==Notes.note_id',
        foreign_keys='(StopTime.stop_note)',
        uselist=False, viewonly=True)
